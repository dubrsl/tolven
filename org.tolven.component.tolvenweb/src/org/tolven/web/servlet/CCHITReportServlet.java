 ...
 *
 */
@Deprecated //the code changes have been moved to ReportServlet in tolvenweb project
public class CCHITReportServlet extends HttpServlet {
    ...
    @EJB
    private CCHITReportLocal reportLocal;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException {
        ...
        /*
         * Opens reports in pdf or xls format, as required
         */
        if (reportFormat == null) {
            reportFormat = "pdf";
        }else if ("xls".toLowerCase().equals(reportFormat.toLowerCase())) {
            /*
             * Let it through
             */
        ...
        tolvenQueryParameter=tolvenQueryParameter==null|| tolvenQueryParameter.trim().equals("")?reportName:tolvenQueryParameter;
        ...
        //response.getOutputStream()= outStream;        
       
        
        try {    
//        	 cchitLocal.findAllMenuDataList(tolvenQueryParameter,
//     				"echr:reports", "",
//     				accountUser);
            ...
            reportLocal.writeReport(reportName, reportType, tolvenQuery, tolvenQueryParameter, sortOrder, sortDirection, activeAccountUser, out, reportFormat);
        } catch (Exception ex) {
