 ...
 *
 * @author Joseph Isaac
 * @version $Id: DatabaseIndexes.java 2862 2011-08-24 03:10:05Z kanag.kuttiannan $
 */
package org.tolven.component.application.database.indexes;
...
/**
 * This plugin updates database indexes
 * 
 * @author Joseph Isaac
 *
 */
public class DatabaseIndexes extends TolvenCommandPlugin {

    public static final String EXTENSIONPOINT_EXECUTE = "execute";

    private Logger logger = Logger.getLogger(DatabaseIndexes.class);
