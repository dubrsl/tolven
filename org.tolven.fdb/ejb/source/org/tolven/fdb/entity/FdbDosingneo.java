...
/**
 * The persistent class for the fdb_dosingneo database table.
 * 
 */
@Entity
@Table(name="fdb_dosingneo")
public class FdbDosingneo implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private FdbDosingneoPK id;
	...
	public FdbDosingneoPK getId() {
		return this.id;
	}

	public void setId(FdbDosingneoPK id) {
		this.id = id;
	}
