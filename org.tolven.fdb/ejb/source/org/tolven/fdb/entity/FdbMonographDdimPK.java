...
/**
 * The primary key class for the fdb_monograph_ddim database table.
 * 
 */
@Embeddable
public class FdbMonographDdimPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FdbMonographDdimPK)) {
			return false;
		}
		FdbMonographDdimPK castOther = (FdbMonographDdimPK)other;
		return 
