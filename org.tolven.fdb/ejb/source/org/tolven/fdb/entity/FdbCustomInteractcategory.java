...
/**
 * The persistent class for the fdb_custom_interactcategory database table.
 * 
 */
@Entity
@Table(name="fdb_custom_interactcategory")
public class FdbCustomInteractcategory implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private FdbCustomInteractcategoryPK id;
    ...
    public FdbCustomInteractcategory() {
    }

	public FdbCustomInteractcategoryPK getId() {
		return this.id;
	}

	public void setId(FdbCustomInteractcategoryPK id) {
		this.id = id;
	}
