...
/**
 * The persistent class for the fdb_user_ddimdruglink_category database table.
 * 
 */
@Entity
@Table(name="fdb_user_ddimdruglink_category")
public class FdbUserDdimdruglinkCategory implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private FdbUserDdimdruglinkCategoryPK id;
    ...
    public FdbUserDdimdruglinkCategory() {
    }

	public FdbUserDdimdruglinkCategoryPK getId() {
		return this.id;
	}

	public void setId(FdbUserDdimdruglinkCategoryPK id) {
		this.id = id;
	}
