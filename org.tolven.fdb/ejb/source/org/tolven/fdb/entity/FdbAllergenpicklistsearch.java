...
/**
 * The persistent class for the fdb_allergenpicklistsearch database table.
 * 
 */
@Entity
@Table(name="fdb_allergenpicklistsearch")
public class FdbAllergenpicklistsearch implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private FdbAllergenpicklistsearchPK id;
    ...
    public FdbAllergenpicklistsearch() {
    }

	public FdbAllergenpicklistsearchPK getId() {
		return this.id;
	}

	public void setId(FdbAllergenpicklistsearchPK id) {
		this.id = id;
	}
