...
/**
 * The persistent class for the fdb_manufdrugsearch database table.
 * 
 */
@Entity
@Table(name="fdb_manufdrugsearch")
public class FdbManufdrugsearch implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private FdbManufdrugsearchPK id;
    ...
    public FdbManufdrugsearch() {
    }

	public FdbManufdrugsearchPK getId() {
		return this.id;
	}

	public void setId(FdbManufdrugsearchPK id) {
		this.id = id;
	}
