...
/**
 * The persistent class for the fdb_classification_fdb database table.
 * 
 */
@Entity
@Table(name="fdb_classification_fdb")
public class FdbClassificationFdb implements Serializable {
