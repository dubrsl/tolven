...
/**
 * The primary key class for the fdb_custom_dosingneo database table.
 * 
 */
@Embeddable
public class FdbCustomDosingneoPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FdbCustomDosingneoPK)) {
			return false;
		}
		FdbCustomDosingneoPK castOther = (FdbCustomDosingneoPK)other;
		return 
