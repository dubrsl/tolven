...
/**
 * The primary key class for the fdb_damscreen_ii database table.
 * 
 */
@Embeddable
public class FdbDamscreenIiPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FdbDamscreenIiPK)) {
			return false;
		}
		FdbDamscreenIiPK castOther = (FdbDamscreenIiPK)other;
		return 
