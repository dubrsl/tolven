...
/**
 * The primary key class for the fdb_custom_msg_text database table.
 * 
 */
@Embeddable
public class FdbCustomMsgTextPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FdbCustomMsgTextPK)) {
			return false;
		}
		FdbCustomMsgTextPK castOther = (FdbCustomMsgTextPK)other;
		return 
