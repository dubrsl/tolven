...
/**
 * The primary key class for the fdb_custom_doserangecheck database table.
 * 
 */
@Embeddable
public class FdbCustomDoserangecheckPK implements Serializable {
    ...
    public FdbCustomDoserangecheckPK() {
    }
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FdbCustomDoserangecheckPK)) {
			return false;
		}
		FdbCustomDoserangecheckPK castOther = (FdbCustomDoserangecheckPK)other;
		return 
