...
/**
 * The primary key class for the fdb_concept_iisurvey database table.
 * 
 */
@Embeddable
public class FdbConceptIisurveyPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FdbConceptIisurveyPK)) {
			return false;
		}
		FdbConceptIisurveyPK castOther = (FdbConceptIisurveyPK)other;
		return 
