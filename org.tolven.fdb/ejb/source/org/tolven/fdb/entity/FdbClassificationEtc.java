...
/**
 * The persistent class for the fdb_classification_etc database table.
 * 
 */
@Entity
@Table(name="fdb_classification_etc")
public class FdbClassificationEtc implements Serializable {
	...
	private Integer ultiparentid;

    public FdbClassificationEtc() {
    }
	...
	public Integer getUltiparentid() {
		return this.ultiparentid;
	}

	public void setUltiparentid(Integer ultiparentid) {
