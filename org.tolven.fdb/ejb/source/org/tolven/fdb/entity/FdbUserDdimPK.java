...
/**
 * The primary key class for the fdb_user_ddim database table.
 * 
 */
@Embeddable
public class FdbUserDdimPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FdbUserDdimPK)) {
			return false;
		}
		FdbUserDdimPK castOther = (FdbUserDdimPK)other;
		return 
