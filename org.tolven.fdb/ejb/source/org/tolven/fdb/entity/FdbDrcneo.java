...
/**
 * The persistent class for the fdb_drcneo database table.
 * 
 */
@Entity
@Table(name="fdb_drcneo")
public class FdbDrcneo implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private FdbDrcneoPK id;
	...
	public FdbDrcneoPK getId() {
		return this.id;
	}

	public void setId(FdbDrcneoPK id) {
		this.id = id;
	}
