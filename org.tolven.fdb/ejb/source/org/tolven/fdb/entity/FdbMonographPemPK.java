...
/**
 * The primary key class for the fdb_monograph_pem database table.
 * 
 */
@Embeddable
public class FdbMonographPemPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FdbMonographPemPK)) {
			return false;
		}
		FdbMonographPemPK castOther = (FdbMonographPemPK)other;
		return 
