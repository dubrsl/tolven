...
/**
 * The persistent class for the fdb_damscreeninfo database table.
 * 
 */
@Entity
@Table(name="fdb_damscreeninfo")
public class FdbDamscreeninfo implements Serializable {
