...
/**
 * The persistent class for the fdb_classification_ext database table.
 * 
 */
@Entity
@Table(name="fdb_classification_ext")
public class FdbClassificationExt implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private FdbClassificationExtPK id;
    ...
    public FdbClassificationExt() {
    }

	public FdbClassificationExtPK getId() {
		return this.id;
	}

	public void setId(FdbClassificationExtPK id) {
		this.id = id;
	}
