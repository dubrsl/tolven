...
/**
 * The persistent class for the fdb_allergengroup_ii database table.
 * 
 */
@Entity
@Table(name="fdb_allergengroup_ii")
public class FdbAllergengroupIi implements Serializable {
