...
/**
 * The persistent class for the fdb_custom_doserangecheck database table.
 * 
 */
@Entity
@Table(name="fdb_custom_doserangecheck")
public class FdbCustomDoserangecheck implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private FdbCustomDoserangecheckPK id;
    ...
    public FdbCustomDoserangecheck() {
    }

	public FdbCustomDoserangecheckPK getId() {
		return this.id;
	}

	public void setId(FdbCustomDoserangecheckPK id) {
		this.id = id;
	}
