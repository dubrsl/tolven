 ...
 * @author Joseph Isaac
 */
package org.tolven.oracle.indexes;
 ...
 *
 */
public class OracleIndexesDBPlugin extends TolvenCommandPlugin {
    ...
    private Logger logger = Logger.getLogger(OracleIndexesDBPlugin.class);
