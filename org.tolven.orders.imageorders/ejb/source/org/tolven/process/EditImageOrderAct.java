...
public class EditImageOrderAct extends InsertAct {
	...
	public void compute() throws Exception {
		TolvenLogger.info( "Compute enabled=" + isEnabled(), EditImageOrderAct.class);
		...
		if (isEnabled() && StringUtils.isNotBlank(getTemplate())) {		
			...
			if (getAction().equals("add")){
	            ...
	            TolvenLogger.info( "added ...", EditImageOrderAct.class);
			}
			if (getAction().equals("remove")){// Remove	
