  ...
  <table border="0" cellpadding="0" cellspacing="0" align="center" title="">
    ...
    background-repeat:repeat-x;background-position:left top;">
      ...
      <td><div class="logCpy"><span class="logTxtCpy">
        <auth:resBundle bundleName="amAuthUI" resourceKey="This is a software demonstration system. Do not use it to store real medical information. There is no assurance that data entered into this system will be retained, held in confidence, or used in accordance with any government regulations." /></span></div>
      </td>
      <td>&nbsp;</td>
    </tr>
  </table>
