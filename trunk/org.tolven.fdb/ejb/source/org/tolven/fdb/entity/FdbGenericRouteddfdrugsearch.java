...
/**
 * The persistent class for the fdb_generic_routeddfdrugsearch database table.
 * 
 */
@Entity
@Table(name="fdb_generic_routeddfdrugsearch")
public class FdbGenericRouteddfdrugsearch implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private FdbGenericRouteddfdrugsearchPK id;
    ...
    public FdbGenericRouteddfdrugsearch() {
    }

	public FdbGenericRouteddfdrugsearchPK getId() {
		return this.id;
	}

	public void setId(FdbGenericRouteddfdrugsearchPK id) {
		this.id = id;
	}
