...
/**
 * The primary key class for the fdb_fdbclassification_link database table.
 * 
 */
@Embeddable
public class FdbFdbclassificationLinkPK implements Serializable {
    ...
    public FdbFdbclassificationLinkPK() {
    }
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FdbFdbclassificationLinkPK)) {
			return false;
		}
		FdbFdbclassificationLinkPK castOther = (FdbFdbclassificationLinkPK)other;
		return 
