...
/**
 * The persistent class for the fdb_classification_fdbsearch database table.
 * 
 */
@Entity
@Table(name="fdb_classification_fdbsearch")
public class FdbClassificationFdbsearch implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private FdbClassificationFdbsearchPK id;
    ...
    public FdbClassificationFdbsearch() {
    }

	public FdbClassificationFdbsearchPK getId() {
		return this.id;
	}

	public void setId(FdbClassificationFdbsearchPK id) {
		this.id = id;
	}
