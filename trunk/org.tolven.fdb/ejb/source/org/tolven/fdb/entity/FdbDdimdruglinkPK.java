...
/**
 * The primary key class for the fdb_ddimdruglink database table.
 * 
 */
@Embeddable
public class FdbDdimdruglinkPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FdbDdimdruglinkPK)) {
			return false;
		}
		FdbDdimdruglinkPK castOther = (FdbDdimdruglinkPK)other;
		return 
