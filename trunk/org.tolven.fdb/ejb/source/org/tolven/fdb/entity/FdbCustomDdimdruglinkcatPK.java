...
/**
 * The primary key class for the fdb_custom_ddimdruglinkcat database table.
 * 
 */
@Embeddable
public class FdbCustomDdimdruglinkcatPK implements Serializable {
    ...
    public FdbCustomDdimdruglinkcatPK() {
    }
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FdbCustomDdimdruglinkcatPK)) {
			return false;
		}
		FdbCustomDdimdruglinkcatPK castOther = (FdbCustomDdimdruglinkcatPK)other;
		return 
