...
/**
 * The persistent class for the fdb_custom_ddim database table.
 * 
 */
@Entity
@Table(name="fdb_custom_ddim")
public class FdbCustomDdim implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private FdbCustomDdimPK id;
    ...
    public FdbCustomDdim() {
    }

	public FdbCustomDdimPK getId() {
		return this.id;
	}

	public void setId(FdbCustomDdimPK id) {
		this.id = id;
	}
