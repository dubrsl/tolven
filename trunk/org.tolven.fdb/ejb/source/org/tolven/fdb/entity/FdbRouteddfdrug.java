...
/**
 * The persistent class for the fdb_routeddfdrug database table.
 * 
 */
@Entity
@Table(name="fdb_routeddfdrug")
public class FdbRouteddfdrug implements Serializable {
