...
/**
 * The persistent class for the fdb_generic_routeddrug database table.
 * 
 */
@Entity
@Table(name="fdb_generic_routeddrug")
public class FdbGenericRouteddrug implements Serializable {
	...
	public String getRtgenidstring() {
		return this.rtgenidstring;
	}

	public void setRtgenidstring(String rtgenidstring) {
		this.rtgenidstring = rtgenidstring;
	}
