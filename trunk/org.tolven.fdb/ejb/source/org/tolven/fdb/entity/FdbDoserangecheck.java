...
/**
 * The persistent class for the fdb_doserangecheck database table.
 * 
 */
@Entity
@Table(name="fdb_doserangecheck")
public class FdbDoserangecheck implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private FdbDoserangecheckPK id;
    ...
    public FdbDoserangecheck() {
    }

	public FdbDoserangecheckPK getId() {
		return this.id;
	}

	public void setId(FdbDoserangecheckPK id) {
		this.id = id;
	}
