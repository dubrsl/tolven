...
/**
 * The persistent class for the fdb_custom_ddiminteraction database table.
 * 
 */
@Entity
@Table(name="fdb_custom_ddiminteraction")
public class FdbCustomDdiminteraction implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private FdbCustomDdiminteractionPK id;
    ...
    public FdbCustomDdiminteraction() {
    }

	public FdbCustomDdiminteractionPK getId() {
		return this.id;
	}

	public void setId(FdbCustomDdiminteractionPK id) {
		this.id = id;
	}
