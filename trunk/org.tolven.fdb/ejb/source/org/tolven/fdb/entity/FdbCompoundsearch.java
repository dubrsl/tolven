...
/**
 * The persistent class for the fdb_compoundsearch database table.
 * 
 */
@Entity
@Table(name="fdb_compoundsearch")
public class FdbCompoundsearch implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private FdbCompoundsearchPK id;
    ...
    public FdbCompoundsearch() {
    }

	public FdbCompoundsearchPK getId() {
		return this.id;
	}

	public void setId(FdbCompoundsearchPK id) {
		this.id = id;
	}
