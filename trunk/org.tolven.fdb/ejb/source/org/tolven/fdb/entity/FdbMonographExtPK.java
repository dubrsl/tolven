...
/**
 * The primary key class for the fdb_monograph_ext database table.
 * 
 */
@Embeddable
public class FdbMonographExtPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FdbMonographExtPK)) {
			return false;
		}
		FdbMonographExtPK castOther = (FdbMonographExtPK)other;
		return 
