...
/**
 * The persistent class for the fdb_dosing database table.
 * 
 */
@Entity
@Table(name="fdb_dosing")
public class FdbDosing implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private FdbDosingPK id;
	...
	public FdbDosingPK getId() {
		return this.id;
	}

	public void setId(FdbDosingPK id) {
		this.id = id;
	}
