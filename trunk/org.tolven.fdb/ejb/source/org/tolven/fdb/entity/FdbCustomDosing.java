...
/**
 * The persistent class for the fdb_custom_dosing database table.
 * 
 */
@Entity
@Table(name="fdb_custom_dosing")
public class FdbCustomDosing implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private FdbCustomDosingPK id;
    ...
    public FdbCustomDosing() {
    }

	public FdbCustomDosingPK getId() {
		return this.id;
	}

	public void setId(FdbCustomDosingPK id) {
		this.id = id;
	}
