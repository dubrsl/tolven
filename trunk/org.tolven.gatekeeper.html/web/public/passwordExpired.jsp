...
<%
    ...
    */
    ...
    String contextPathPrefix = request.getRequestURL().toString().substring(0, request.getRequestURL().toString().indexOf(request.getContextPath()));
    String loginUrl = contextPathPrefix + contextPath;
...
<hr/>
<a href="<%=loginUrl%>">Return to the <%=loginUrl%> login page.</a>
</body>
</html>
