...
public class DocumentServiceImpl {
    ...
    public String queueMessage(
            @WebParam(name = "payload",targetNamespace = "http://tolven.org/document") byte[] payload,
            @WebParam(name = "xmlns", targetNamespace = "http://tolven.org/document") String xmlns,
            @WebParam(name = "accountId", targetNamespace = "http://tolven.org/document") long accountId) {
