This folder will contain .xhtml files that are general display pages. 
The folder name "five" means nothing, except that it was the one following four, long-since obsolete.
