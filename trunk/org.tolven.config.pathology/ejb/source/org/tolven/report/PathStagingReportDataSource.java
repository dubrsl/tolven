...
public class PathStagingReportDataSource extends TolvenReportDataSource {
	private String laterality;

	public PathStagingReportDataSource(String menuPath, String tolvenQueryParameter,String laterality, AccountUser accountUser) {
    ...
    protected void fetchTolvenReportMaps() throws NamingException {
         ...
         for (MenuData md : menuDatas) {
			if (md.getString01().equals(laterality)) {
