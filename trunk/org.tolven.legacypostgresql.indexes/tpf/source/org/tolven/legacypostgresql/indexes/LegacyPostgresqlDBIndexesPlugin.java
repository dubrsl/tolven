 ...
 * @author Joseph Isaac
 */
package org.tolven.legacypostgresql.indexes;
 ...
 *
 */
public class LegacyPostgresqlDBIndexesPlugin extends TolvenCommandPlugin {
    ...
    private Logger logger = Logger.getLogger(LegacyPostgresqlDBIndexesPlugin.class);
    ...
    public void execute(String[] args) {
        ...
        File sqlFile = null;
        if (sqlFilename == null) {
            String zipSqlFilename = "indexes.sql";
