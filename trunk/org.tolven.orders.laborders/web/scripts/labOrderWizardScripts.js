...
/**
 * Modified 'openTemplate' function to generate lab order pop-ups 
 ...
 * @param gridType
 */
function openLabOrderTemplateWithToolTip(contentName, placeholderid, methodName, formId, index,gridType) {
	var lform = $(formId);
	...
	openLabOrderPopupWithToolTip(contentName, placeholderid, formId, methodName, methodArgsStr, gridType);
}

/**
 * Modified 'openPopup' function to generate lab order pop-ups 
 * with a tool-tip to show the long name of orders.
 * @author Pinky S
 * Added on 02/03/2011
 * @param contentName
 ...
 * @return
 */
function openLabOrderPopupWithToolTip( contentName, placeholderid, formId, methodName, methodArgs, gridType){
	serialNo++;
