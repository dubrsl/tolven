...
public class LoaderImageOrders extends TolvenCommandPlugin {
    protected Logger logger = Logger.getLogger(getClass());

    @Override
    public void execute(String[] args) throws Exception {
        logger.debug("*** execute ***");
        LoadImageOrder loader = new LoadImageOrder(getAdminId(), getAdminPassword(), getAppRestfulRootURL(), getAuthRestfulRootURL());
        File src = getFilePath("tpf/voc/ImageOrderList.txt");
        logger.info("Load Image Orders from " + src.getPath() + "...");        
        loader.load(src.getPath());
        /** commented the following two lines from original
        ...
        ***/        
        logger.info("Load Image Orders completed");
    }
